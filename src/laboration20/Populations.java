...
//        Population[] invåndare = Populations.readPopulations( "M:/java/befolkning.txt" );
        Population[] invåndare = Populations.readPopulations( "src/laboration20/befolkning.txt" );
